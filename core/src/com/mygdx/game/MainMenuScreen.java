...
public class MainMenuScreen implements Screen {
    ...
    private Texture Exit1 = new Texture(Gdx.files.internal("Screenshot (245).png"));
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.getX() > 500 && Gdx.input.getX() < 1000 && Gdx.input.getY() > 50 && Gdx.input.getY() < 200) {
            ...
            if(Gdx.input.getX() > 943 && Gdx.input.getX() < 1050 && Gdx.input.getY() > 470 && Gdx.input.getY() < 590) {
